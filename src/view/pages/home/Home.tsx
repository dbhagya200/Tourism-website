...
export function Home() {
  ...
  const TRIPADVISOR_URL =
    "https://www.tripadvisor.co.uk/Attraction_Review-g297896-d27698089-Reviews-Ceylon_Visit_Tours_Sri_Lanka-Galle_Galle_District_Southern_Province.html";
  ...
  useEffect(() => {
    const loadTripAdvisorWidget = () => {
      ...
      script.src =
        "https://www.jscache.com/wejs?wtype=selfserveprop&uniq=1&locationId=8862399&lang=en_US&rating=true&nreviews=4&writereviewlink=true&popIdx=true&iswide=false&border=true&display_version=2";
      script.async = true;
  ...
  return (
    <main className="bg-gradient-to-b from-white via-sky-50 to-white text-slate-800 font-sans min-h-screen">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <img
          src="https://www.lovesrilanka.org/wp-content/uploads/2020/04/LS_Ella_Main_Desktop_1920x700.jpg"
        ...
        >
          ...
          <p className="text-sky-50 text-base md:text-lg max-w-xl mx-auto mb-8 drop-shadow-md font-medium">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-8 max-w-7xl mx-auto">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-slate-500 text-sm">
              Quick glimpses of the island life
            </p>
          </div>
          <Link
            to="/reels"
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">
              Join hundreds of satisfied guests who've experienced Sri Lanka
              with us
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            {/* Total Reviews */}
            <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-lg text-center">
              <div className="text-5xl font-black text-[#34E0A1] mb-2">
                300+
              </div>
                ...
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      size={16}
                      className="fill-[#1588ff] text-[#1588ff]"
                    />
                  ))}
                </div>
            ...
            <div className="space-y-6" data-aos="fade-left">
              ...
              {latestReviews.map((review) => (
                <div
                  ...
                  onClick={() =>
                    review.sourceUrl && window.open(review.sourceUrl, "_blank")
                  }
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div
                      className={`px-2 py-1 rounded text-xs font-bold ${review.source === "TripAdvisor" ? "bg-[#34E0A1]/10 text-[#34E0A1]" : "bg-blue-100 text-blue-600"}`}
                    >
                      {review.source}
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-7xl mx-auto h-[400px] mb-10">
          ...
          <div className="col-span-2 rounded-2xl overflow-hidden relative group shadow-lg">
            ...
            >
              ...
              <span className="text-white font-bold text-lg drop-shadow-lg tracking-wider">
                VIEW GALLERY
              </span>
      ...
      <section className="py-20 px-6 md:px-12 bg-sky-50">
        <div
          className="max-w-5xl mx-auto bg-gradient-to-r from-sky-400 to-blue-600 rounded-[2.5rem] p-10 md:p-16 text-center text-white shadow-2xl shadow-sky-400/30 relative overflow-hidden"
          data-aos="zoom-in"
        >
          ...
          <h2 className="text-3xl md:text-5xl font-serif font-black mb-4 relative z-10">
            Ready for your <br />
            Dream Vacation?
          </h2>
          <p className="text-sky-100 text-base md:text-xl max-w-xl mx-auto mb-8 relative z-10 font-light">
            Join hundreds of happy travelers who rated us 5 stars across all
            platforms. Let us handle the details while you create the memories.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="inline-flex items-center gap-3 bg-white text-blue-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-sky-50 hover:shadow-xl hover:scale-105 transition-all relative z-10 shadow-lg"
            >
              <MapPin size={20} />
              Plan My Trip
            </Link>
