...
export function Footer() {
    return (
        // THEME: Deep Ocean Gradient (Dark Slate -> Deep Blue) to contrast with the light body
        <footer className="bg-gradient-to-br from-slate-900 to-blue-950 border-t border-sky-900/30 py-16 px-8 mt-auto text-white">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-sky-100/80 mb-6 text-sm leading-relaxed max-w-sm">
                        ...
                        <div className="flex gap-3">
                            {[
                                ...
                                <a
                                    ...
                                    // Button: Glass effect -> Sky Blue hover
                                    className="w-11 h-11 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center text-sky-100 hover:bg-sky-500 hover:text-white hover:border-sky-500 hover:-translate-y-1 transition-all duration-300 shadow-lg shadow-black/20"
                        ...
                        <ul className="space-y-2">
                            {[
                                ...
                                <li key={link.to}>
                                    ...
                                    >
                                        <span className="w-1.5 h-1.5 rounded-full bg-sky-500/0 group-hover:bg-sky-500 transition-all duration-300"></span>
                                        {link.label}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 group">
                                ...
                                <span className="text-sky-100/80 text-sm mt-1.5">+94 77 123 4567</span>
                            </li>
                            <li className="flex items-start gap-3 group">
                                <div className="p-2 rounded-lg bg-sky-900/30 text-sky-400 group-hover:bg-sky-500 group-hover:text-white transition-colors duration-300">
                                    <Mail size={18} />
                                </div>
                                <span className="text-sky-100/80 text-sm mt-1.5">
                ...
                {/* Divider */}
                <div className="border-t border-sky-900/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-center md:text-left text-sky-200/50 text-sm">
                        &copy; 2026 Ceylon Vista Tours Sri Lanka. All Rights Reserved.
                    </p>
                    <div className="flex gap-6 text-sm text-sky-200/50">
